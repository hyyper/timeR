...
TimeR.prototype.countDown = function() {
    ...
    this.setInterval = setInterval(()=> {
        ...
        this.now        = this.now.add(1, "seconds");

        // Detect
        this.time.units = this._changeSingularPlural(this.time);


        // Check if countDown is complete
        this._checkTimeRComplete({
            years   : this.time.years(),
            months  : this.time.months(),
            days    : this.time.days(), 
...
TimeR.prototype.display = function(time) {
    ...
    document.getElementById(this.id).innerHTML = (time) ? `<div class="countdown">

            <div class="countdown--digit">
                <span id="countdown--days">`+time.days+`</span>
            ...
            <div class="countdown--digit">
                <span id="countdown--hours">`+time.hours+`</span>
                <div class="countdown--unit">
                    `+time.units['hours']+`
                </div>
            </div>
            ...
            <div class="countdown--digit">
                <span id="countdown--minutes">`+time.minutes+`</span>
                <div class="countdown--unit">
                    `+time.units['minutes']+`
                </div>
            </div>
            ...
            <div class="countdown--digit">
                <span id="countdown--seconds">`+time.seconds+`</span>
                <div class="countdown--unit">
                    `+time.units['seconds']+`
                </div>
            </div>
